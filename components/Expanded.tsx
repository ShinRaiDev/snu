...
function Expanded(props:any) {
  ...
  return (
    <div>
      <div className={`${exp? "h-96 border-b-[11px]"+background:""} transition-all	ease-linear delay-150 border-black border-2 border-b-8 bg-white p-5 rounded-2xl w-96   `+background}>
